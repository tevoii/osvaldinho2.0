...
DONO DA API: wa.me/+555491057713
CRIADO DA CASE: TEVO `
			        reply(placa)
					break
                case 'cpfg':
...
// recursos anime, random @dark domina vida
          ...
          reply('Espere..')
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* TEVO\n*WPP:* wa.me/+555491057713\n\n\nEspero que tenham gostado do osvaldinho 2.0️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
